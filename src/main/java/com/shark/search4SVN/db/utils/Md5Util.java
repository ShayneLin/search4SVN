 ...
 * @Author lcs
 * @Description
 * @Date Created in 17:35 2018/6/26
 * MD5工具类，用来做数据库中记录的唯一标识符，虽然可能会冲突，但是其概率可以忽略
 */
public class Md5Util {
    ...
    public static void main(String[] args) {
        System.out.println(md5("sdafsafdfs"));
        System.out.println("fb7d9215c268bd2e405c4580f6e9376f".length());
    }
    private Md5Util() {
    }
